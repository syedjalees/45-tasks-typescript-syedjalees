...
let favorite_pizza :string[] = ["kababish","creamy","supreme"]
for(let i=0; i<favorite_pizza.length; i++){
    console.log("I like "+favorite_pizza[i]+" pizza");
    
}
console.log("I really love kababish pizza");
console.log("I really love creamy pizza");
console.log("I really love supreme pizza");