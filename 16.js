...
let guest_list = ["Governor sb", "Sir Zia Khan", "Daniyal Nagori sb"];
let canNotCome = "Governor sb";
let unavailable_guest = guest_list.indexOf(canNotCome);
...
let new_guest1 = guest_list.unshift("Sir Qasim"); // add new guest in beggining of array
let new_guest2 = guest_list.splice(2, 0, "Sir Okasha"); // add new guest in middle 
let new_guest3 = guest_list.push("Sir Aneeq"); // adding new guest in last of array
