...
let guest_list:string[]=["Uzair", "Rizwan", "Anas","Zain","Karim","Kashif"]// i make a new original list 
...
while (guest_list.length > 2){
    let remove_guests:any = guest_list.pop(); // removing the guests more than two
